...
<body>
<style type="text/css">
    .alert{background-color:#f1f1f1; width:300px;margin:50px auto; font-size:12px; line-height:24px;}
    .alert .alert_body{ border:1px solid #cbcbcb;background-color:#fff; width:280px; height:143px; position:relative; /*top:-5px; left:-5px; */padding:10px;}
    .alert .alert_body h3{font-size:14px; font-weight:bold; margin:0;}
    .alert .alert_body .alertcont{margin:15px 0 0 10px; padding:5px 50px; line-height:30px; color:#666; min-height:30px; _height:30px;}
    ...
    .message .alert_body{ padding:0; height:163px; width:300px; border:1px solid #cae3eb;}
