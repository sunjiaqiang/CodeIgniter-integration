	    ...
	    <div class="table_full">
	        <table width="100%">
	            ...
	            <tr>
	                <th>父级菜单</th>
	                <td>
	                    <select name="Form[parent_id]" class="select rounded" style="font-family: 'Courier New', Courier, monospace;">
	            ...
	            <tr>
	                <th>参数</th>
	                <td><input type="text" value="<?php echo $row['parameter'];?>" name="Form[parameter]" class="input rounded" size="30" /><span>例:groupid=1&type=2</span></td>
	            </tr>
	            <tr>
	                <th>排序</th>
	            ...
	            <tr>
	                <th>状态</th>
	                <td>
	                    <label><input type="radio" value="1"<?php if($row['status']==1):?> checked="checked"<?php endif;?> name="Form[status]" />显示</label>
                        <label><input type="radio" value="0"<?php if($row['status']==0):?> checked="checked"<?php endif;?> name="Form[status]" />不显示</label>
                        <span>需要明显不确定的操作时建议设置为不显示，例如：删除，修改等</span>
                    </td>
	            </tr>
<!--	            <tr>-->
<!--	                <th>类型</th>-->
<!--	                <td>-->
<!--	                    <label><input type="radio" value="1"--><?php //if($row['type']==1):?><!-- checked="checked"--><?php //endif;?><!-- name="Form[type]" />权限认证+菜单</label>-->
<!--	                    <label><input type="radio" value="0"--><?php //if($row['type']==0):?><!-- checked="checked"--><?php //endif;?><!-- name="Form[type]" />菜单项</label>-->
<!--	                    <span>注意：“权限认证+菜单”表示加入后台权限管理，纯粹是菜单项请不要选择此项。</span>-->
<!--                    </td>-->
<!--	            </tr>-->
