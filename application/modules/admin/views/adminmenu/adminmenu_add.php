    ...
    <div class="table_full">
	    ...
	    <div class="table_full">
	        <table width="100%">
	            ...
	            <tr>
	                <th>参数</th>
	                <td><input type="text" name="Form[parameter]" value="" class="input rounded" size="30" /><span>例:groupid=1&type=2</span></td>
	            </tr>
	            <tr>
	                <th>排序</th>
	            ...
	            <tr>
	                <th>状态</th>
	                <td>
	                    <label><input type="radio" value="1" name="Form[status]" checked="checked" />显示</label>
                        <label><input type="radio" value="0" name="Form[status]" />不显示</label> 
