...
<link href="<?php echo STATIC_PATH;?>lib/zTree/zTreeStyle/zTreeStyle.css" rel="stylesheet" />
<script type="text/javascript" src="<?php echo STATIC_PATH;?>lib/zTree/jquery.ztree.core-3.5.js"></script>
<script type="text/javascript" src="<?php echo STATIC_PATH;?>lib/zTree/jquery.ztree.excheck-3.5.js"></script>
</head>
<body>
...
<div class="wrap">
    ...
    <div class="nav">
        <ul>
            <li><a href="<?php echo site_url('buyer/role/index')?>">角色管理</a></li>
            <li><a href="<?php echo site_url('buyer/role/add')?>">添加角色</a></li>
