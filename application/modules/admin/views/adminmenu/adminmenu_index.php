        ...
        <tbody>
          ...
          <tr>
            <td class="btn_min"><div class="operat hidden"> <a class="icon-cog action" href="javascript:;">处理</a>
                <div class="menu_select">
                  <ul>
                    <li><a class="icon-pencil" href="<?=site_url('admin/index/adminmenu_edit?id='.$v['id']) ?>">编辑</a></li>
                    <li><a class="icon-remove-2 doDel" href="javascript:;" data-uri="<?=site_url('admin/index/ajax_remove_adminmenu?id='.$v['id'])?>">删除</a></li>
                  </ul>
                </div>
              </div></td>
          ...
          <tr style="display: none" class="level_<?=$v['id']?>">
            <td class="btn_min"><div class="operat hidden"> <a class="icon-cog action" href="javascript:;">处理</a>
                <div class="menu_select">
                  <ul>
                    <li><a class="icon-pencil" href="<?=site_url('admin/index/adminmenu_edit?id='.$v1['id']) ?>">编辑</a></li>
                    <li><a class="icon-remove-2 doDel" href="javascript:;" data-uri="<?=site_url('admin/index/ajax_remove_adminmenu?id='.$v1['id'])?>">删除</a></li>
                  </ul>
                </div>
              </div></td>
          ...
          <tr style="display: none" class="level_<?=$v['id']?> leveo_<?=$v['id']?> level_<?=$v1['id']?>">
            <td class="btn_min"><div class="operat hidden"> <a class="icon-cog action" href="javascript:;">处理</a>
                <div class="menu_select">
                  <ul>
                    <li><a class="icon-pencil" href="<?=site_url('admin/index/adminmenu_edit?id='.$v2['id']) ?>">编辑</a></li>
                    <li><a class="icon-remove-2 doDel" href="javascript:;" data-uri="<?=site_url('admin/index/ajax_remove_adminmenu?id='.$v2['id'])?>">删除</a></li>
                  </ul>
                </div>
              </div></td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;├─ <?=$v2['name'];?></td>
  ...
  function edit_sort(obj){
    ...
    $.ajax({
      ...
      success:function(result){
       if(result==1){
          window.location.href="<?=site_url('admin/index/adminmenu')?>";
       }else{
