  ...
  <div class="ui-bg-v1">
    <div class="bg-default p20">
      ...
      <form method="post" class="iframe-input-checkform">
        <div class="check-input mr15 fr"> <a href="<?=site_url('admin/adminrole/index')?>" class="button-middle-v2 button-bg-yellow button-font-white"> 角色列表 </a> </div>
      </form>
          ...
          <div class="table_full">
            <table width="100%">
              ...
              <tbody>
                <tr>
                  <th>角色名称</th>
                  <td><input type="text" value="" name="Form[name]" class="input rounded" size="30" validate="{required:true,rangelength:[1,20],remote:'<?=$ajax_check_name;?>'}" /></td>
                </tr>
                <tr>
                  <th>角色描述</th>
                ...
                <tr>
                  <th>状态</th>
                  <td><label>
                    <input type="radio" value="1" checked name="Form[status]" />
                    启用</label>
                    <label>
