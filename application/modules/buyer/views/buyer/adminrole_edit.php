    ...
    <div class="table_full">
	    ...
	    <div class="table_full">
	        <table width="100%">
	            ...
	            <tr>
	                <th>角色名称</th>
	                <td><input type="text" value="<?php echo $row['name'];?>" name="Form[name]" class="input rounded" size="30" validate="{required:true,rangelength:[1,20],remote:'<?php echo $ajax_check_name;?>'}" /></td>
	            </tr>
	            <tr>
	                <th>角色描述</th>
	            ...
	            <tr>
	                <th>状态</th>
	                <td>
	                    <label><input type="radio" value="1"<?php if($row['status']==1):?> checked="checked"<?php endif;?> name="Form[status]" />启用</label>
                        <label><input type="radio" value="0"<?php if($row['status']==0):?> checked="checked"<?php endif;?> name="Form[status]" />禁用</label>
                    </td>
	            </tr>
	            </tbody>
	        </table>
